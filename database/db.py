...
class Database:
    ...
    def set_affiliate_tag(self, tag: str) -> None:
        self._set_setting("affiliate_tag", tag)

    def get_affiliate_tag(self) -> str:
        return self._get_setting("affiliate_tag", "")

    def clear_affiliate_tag(self) -> None:
        self._set_setting("affiliate_tag", "")

    def set_amazon_domain(self, domain: str) -> None:
        self._set_setting("amazon_domain", domain)

    def get_amazon_domain(self) -> str:
        return self._get_setting("amazon_domain", "amazon.in")
