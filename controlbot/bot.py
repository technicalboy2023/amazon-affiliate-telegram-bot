...
async def _register_commands(app: Application) -> None:
    ...
    commands = [
        ...
        BotCommand("set_tag", "🔗 Set affiliate tag"),
        BotCommand("clear_tag", "🗑️ Remove affiliate tag"),
        BotCommand("set_domain", "🌐 Set default amazon domain"),
...
def build_application(db: Database) -> Application:
    ...
    # Amazon Affiliate
    _add_handler(app, "set_tag", set_tag)
    _add_handler(app, "clear_tag", clear_tag)
    _add_handler(app, "set_domain", set_domain)
